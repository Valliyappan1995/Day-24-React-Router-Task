...
const allInfo = {
  ...
  description:
    "To make best use of the learning progress practise the day to day tasks and if you have any questions make use of blogs and raise queries if you face any difficulities.",
};
...
const careerInfo = {
  title: "CAREER",
  description:
    "We have many opportunities in the organization as you learn you can be placed in one of the big MNC's.",
};
...
const careerBlogs = [
  ...
  {
    imageUrl:
      "https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-Mechanical-Engineering-Webinars-and-Workshops-That-You-Should-Know.webp",
    title:
  ...
  {
    imageUrl:
      "https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-Fascinating-Career-Opportunities-in-Civil-Engineering.webp",
  ...
  {
    imageUrl:
      "https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-The-Promising-Scope-of-Civil-Engineering-in-India.webp",
  ...
  {
    imageUrl:
      "https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-Best-Skills-Required-to-Become-a-Civil-Engineer-1.webp",
...
const allBlogs = fSDBlogs.concat(
  dataScienceBlogs,
  cyberSecurityBlogs,
  careerBlogs
);
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          <Route
            path="/"
            element={<All blogsHeader={allInfo} blogs={allBlogs} />}
          />
          <Route
            path="/fSD"
            element={<FSD blogsHeader={fSDInfo} blogs={fSDBlogs} />}
          />
          <Route
            path="/dataScience"
            element={
              <DataScience
                blogsHeader={dataScienceInfo}
                blogs={dataScienceBlogs}
              />
            }
          />
          <Route
            ...
            element={
              <CyberSecurity
                blogsHeader={cyberSecurityInfo}
                blogs={cyberSecurityBlogs}
              />
            }
          />
          <Route
            path="/career"
            element={<Career blogsHeader={careerInfo} blogs={careerBlogs} />}
          />
        </Routes>
        <Footer />
      </div>
